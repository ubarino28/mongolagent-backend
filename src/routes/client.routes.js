  ...
  try {
    ...
    const CHAT_TOOLS = [
      ...
      },
      {
        ...
        function: {
          name: "check_menu",
          description: "Бүх бараа/бүтээгдэхүүний жагсаалтыг ангилалаар нь авна. Хэрэглэгч 'ямар бараа байна?', 'юу зардаг вэ?', 'бараагаа харуулаач' гэх ЕРӨНХИЙ асуулт асуувал дуудна.",
