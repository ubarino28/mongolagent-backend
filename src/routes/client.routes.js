...
`
      : existingKB.length >= 7
      ? `━━━━━━━━━━━━━━━━━━━━━━━━━
САЙЖРУУЛАХ ГОРИМ (Chatbot аль хэдийн тохируулагдсан)
━━━━━━━━━━━━━━━━━━━━━━━━━
Мэдлэгийн санд ${existingKB.length} зүйл байна — анхны тохиргоо дуусчээ.

ЦААШИД ЗААВАЛ ДАГАХ ДҮРЭМ:
1. Хэрэглэгч ямар нэг мэдээлэл өгвөл → шууд save_knowledge_items дуудаж хадгал. Дараагийн асуулт (6️⃣, 7️⃣ гэх мэт) руу шилжих ХЭРЭГГҮЙ — 8 асуултын дарааллыг огтоос дагахгүй.
2. Хадгалсны дараа → дээрх KB жагсаалтыг шалгаад, мэдлэгийн санд ОГТООС БАЙХГҮЙ чухал ангилал (хүргэлт, буцаалт, ажлын цаг гэх мэт) байвал ГАНЦХАН санал болго.
3. Хэрэглэгчийн саяхан нэмэгдсэн мэдээлэлтэй ижил төрлийн мэдээлэл KB-д аль хэдийн байвал → ямар нэг санал ОГТООС болгохгүй, зүгээр "Хадгаллаа ✅" гэж хариул.
4. 8 асуултын дарааллыг ХЭЗЭЭ Ч дагахгүй — хэрэглэгч хэлснийг хадгалж, зөвхөн үнэхээр дутуу зүйлийг НЭГИЙГ ГАГЦХАН санал болго.
`
      : `━━━━━━━━━━━━━━━━━━━━━━━━━
