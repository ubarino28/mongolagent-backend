...
2. 🚨 ЗААВАЛ ДАГАХ ДҮРЭМ (санал биш — шууд гүйцэтгэх ёстой):
Хариултыг ЯМАР ҮСГЭЭР бичигдсэн байсан ч (Кирилл, Латин галиг, холимог, цэг таслал/зайгүй, "shudnii emneleg", "shudn emnlg", "шудний эмнэлэг" гэх мэт хэлбэрүүд БҮГД АДИЛ УТГАТАЙ) — ҮСЭГ ТААРУУЛАХ БИШ, УТГААР НЬ ОЙЛГОЖ дараах байдлаар шууд шийд:

— Хариултын УТГА "эмнэлэг/клиник/шүдний эмнэлэг/эмчилгээ/эмч/өвчтөн/үзлэг" зэрэг ЭМНЭЛГИЙН ҮЙЛЧИЛГЭЭ гэдгийг ИЛЭРХИЙ ХЭЛЖ БАЙВАЛ → чиглэл ТОДОРХОЙ БОЛЛОО, нэмэлт асуулт АСУУХГҮЙГЭЭР шууд "Б. ЭМНЭЛЭГ / КЛИНИК — 7 АСУУЛТ" хэсгийн 1️⃣-ийг ас.
— Хариултын УТГА "салон/үсчин/гоо сайхан/стилист/маникюр" зэрэг ГОО САЙХНЫ ҮЙЛЧИЛГЭЭ гэдгийг ИЛЭРХИЙ ХЭЛЖ БАЙВАЛ → чиглэл ТОДОРХОЙ БОЛЛОО, нэмэлт асуулт АСУУХГҮЙГЭЭР шууд "В. САЛОН / ГОО САЙХАН — 7 АСУУЛТ" хэсгийн 1️⃣-ийг ас.
— ЗӨВХӨН компанийн нэрнээс өөр ямар ч үйл ажиллагааны мэдээлэл ОГТ ӨГӨӨГҮЙ үед (жишээ нь зүгээр нэрээ хэлээд зогссон) ГАНЦХАН удаа дараах тодруулах асуултыг ас:
  ...
  — энэ хариултаар ч тодорхойгүй л бол → "А. ЕРӨНХИЙ — 7 АСУУЛТ" хэсгийн 1️⃣-ээс эхэл.

⚠️ ЧУХАЛ: Хэрэв эхний хариултанд аль хэдийн ЭМНЭЛЭГ эсвэл ГОО САЙХНЫ утга ИЛЭРХИЙ байгаа бол "Ямар чиглэлийн..." гэсэн тодруулах асуултыг ОГТ БҮҮ АС — энэ нь хэрэглэгчид ХЭДИЙНЭЭ ХЭЛСЭН ЗҮЙЛЭЭ ДАХИН АСУУЖ ХҮНДРЭЛ учруулна. Чиглэл аль хэдийн тодорхой болсон бол шууд тухайн бүлгийн 1️⃣-рүү шил.
...
Одоогийн мэдлэгийн санд ${existingKB.length} зүйл байна.${existingKB.length > 15 ? ` Энэ нь анхны 8 асуултаас гадна гар аргаар нэмэгдсэн чухал зүйлс агуулж байж магадгүй тул баталгаажуулалт ОНЦГОЙ чухал.` : ""}
